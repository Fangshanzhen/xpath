...
public class xmlTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String s = "clientId=q_client24&idCard=61052619860815371X&idType=01&nonce=qA75EBuk1dacjHRG&secret=cbf41a26e8bb4d75a083a0c8d2cca5b2&timestamp=" + timestampMillis;
        System.out.println(s);
        String s1 = sha1(s);

        // The string you want to encrypt
        String data = "{\"info\":{\"clientId\":\"q_client24\",\"secret\":\"cbf41a26e8bb4d75a083a0c8d2cca5b2\",\"idType\":\"01\",\"idCard\":\"61052619860815371X\"},\"timestamp\":\"#\",\"nonce\":\"qA75EBuk1dacjHRG\",\"signature\":\"@\"}"
